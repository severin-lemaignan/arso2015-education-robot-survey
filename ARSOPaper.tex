...
\multicolumn{1}{c|}{\cellcolor[HTML]{FFFFFF}\textbf{\begin{tabular}[c]{@{}c@{}}Mindstorms \\ 
...
\multicolumn{1}{c|}{\cellcolor[HTML]{FFFFFF}LEGO}                                                            
...
The robot design kit used in most of the aforementioned educational activities was primarily the LEGO 
Mindstorms NXT 2.0. The kit consists of LEGO bricks, motors, gears, sensors (ultrasonic, sound, touch, and 
...
existing commercial LEGO-like robotic kits; the list includes the latest LEGO Mindstorms EV3 
